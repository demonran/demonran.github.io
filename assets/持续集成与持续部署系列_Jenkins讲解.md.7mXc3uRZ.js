import{_ as n,c as s,o as a,a1 as p}from"./chunks/framework.rLRl8Q3O.js";const e="/assets/jenkins_env.EwlaDf8L.png",v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"持续集成与持续部署系列/Jenkins讲解.md","filePath":"持续集成与持续部署系列/Jenkins讲解.md","lastUpdated":1733724441000}'),l={name:"持续集成与持续部署系列/Jenkins讲解.md"},i=p(`<p>查看 Jenkins 系统内置环境变量 方法一： \${YOUR_JENKINS_HOST}/env-vars.html</p><p>方式二： 通过执行 printenv shell 命令来获取：</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>pipeline {</span></span>
