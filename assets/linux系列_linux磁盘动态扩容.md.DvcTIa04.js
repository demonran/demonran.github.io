import{_ as s,c as n,o as a,a1 as e}from"./chunks/framework.rLRl8Q3O.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"linux系列/linux磁盘动态扩容.md","filePath":"linux系列/linux磁盘动态扩容.md","lastUpdated":1720510408000}'),p={name:"linux系列/linux磁盘动态扩容.md"},l=e(`<h3 id="使用lvm动态扩容磁盘" tabindex="-1">使用lvm动态扩容磁盘 <a class="header-anchor" href="#使用lvm动态扩容磁盘" aria-label="Permalink to &quot;使用lvm动态扩容磁盘&quot;">​</a></h3><h4 id="磁盘分区" tabindex="-1">磁盘分区 <a class="header-anchor" href="#磁盘分区" aria-label="Permalink to &quot;磁盘分区&quot;">​</a></h4><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>fdisk /dev/vdc</span></span>
